...
- Whether you believe the issue is exploitable in typical `harn` usage (local scaffold / CI).

We aim to acknowledge reports within a few business days and coordinate disclosure once a fix is ready.

## Scope notes

- `harn` runs locally and writes files under the project directory. Treat untrusted project templates and third-party toolpacks like any other supply-chain dependency.
